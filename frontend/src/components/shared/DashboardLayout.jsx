...
import { ShieldAlert, Bell, Home, TestTube, BarChart3, MapPin, Menu, X, AlertTriangle } from "lucide-react";
...
function Header() {
  ...
  const navigation = [
    ...
    { name: 'Priority List', href: '/priority-list', icon: ShieldAlert },
  ];
          ...
          <div className="flex h-16 items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-full font-bold text-sm shadow-lg shadow-red-200 transition-all hover:scale-105 active:scale-95 animate-pulse"
              >
